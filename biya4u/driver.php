...
$err=array('Please Fill The Driver');
...
$query=mysqli_query($conn, "select * from driver where category='$cat'");
...
if($num>0)
{
echo "<li>Driver already Exists</li>";
...
$insert= mysqli_query($conn, "insert into driver values('','$cat')");
 if($insert)
 {
 
 ?><script type="text/javascript">alert('Driver Added Successfully'); self.location='driver.php';</script><?php
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  align="center">
  ...
  <tr>
    <td ><p align="center" class="style1"> Driver Name</p>
        <span class="">
        <?php if($_POST['submit'])
{
