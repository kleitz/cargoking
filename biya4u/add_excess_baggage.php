<?php 
  ...
  if($_POST['submit']) {
    ...
    $SQLInsert .= " values (" . EXCESS_BAGGAGE_ID . ", '" . $code . "', '" . $identificationType . "', '" . $identificationNumber . "', '" . $firstName . "', '" . $lastName . "', '" . $middleName . "', '" . $area_name . "', '" . $phoneNumber . "', '" . $emailAddress . "', '" . $username . "', '" . $password . "', '" . $login_id . "', now(), '" . $login_id . "', now())";
    $successInsertion = mysqli_query($conn,  $SQLInsert );

    if( $successInsertion ) {
      echo "<script type=\"text/javascript\">";
      echo "  self.location='excess_baggage_list.php?action=add&success=true';";
      echo "</script>";
    }
    else {
...
<head>
    ...
    <title>Cargo King: Add Excess Baggage Staff</title>
  ...
  <center>
    ...
    <div class="containers contents">
      <div class="contentContainer">
        ...
        <!-- Title -->      
        <div align="center" class="title">Add Excess Baggage Staff</div>
          ...
          <div>
            ...
            <form id="frmStationAdmin" name="frmStationAdmin" action="" method="post">           
                ...
                <p align="right" style="margin-right: 10px;">
                  <input type="submit" id="btnAddUser" name="submit" value="Add Excess Baggage Staff" class="button" />
                </p>
            </form>
          </div>
        </div>
