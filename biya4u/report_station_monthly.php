<?php
	...
	$downloadUrl = "xl_station_monthly.php";
	...
	$sqlTotalCount = " select count(id) as row_count from vw_booking_previous_month WHERE origin_id = " . $stationId . " limit 1 ";
									...
									<table cellpadding="0" cellspacing="0" border="0" width="900" bgcolor="#FFFFFF">
										<tr>
											<td colspan="2" align="center" style="height: 50px;">
												...
												Station Monthly Sales Report for ( <?php echo $station_name; ?> )
												</span>
											</td>
										</tr>
