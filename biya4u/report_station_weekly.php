<?php
	...
	$downloadUrl = "xl_station_weekly.php?";
	...
	$sqlTotalCount = " select count(id) as row_count from vw_booking_previous_week WHERE origin_id = " . $stationId . " limit 1 ";
	...
	$SQLStationTotals = " SELECT b.*, (b.insured_rate - b.discounted_total) as discounts FROM vw_booking_station_totals_weekly b WHERE b.origin_id = " . $stationId;
									...
									<table cellpadding="0" cellspacing="0" border="0" width="900" bgcolor="#FFFFFF">
										<tr>
											<td colspan="2" align="center" style="height: 50px;">
												...
												Station Weekly Sales Report for ( <?php echo $station_name; ?> )
												</span>
											</td>
										</tr>
