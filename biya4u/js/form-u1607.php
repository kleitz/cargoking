...
{
	$to = 'jpcanangga@biyahelocity.com';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U1661"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Contact Number:</b></td><td>' . htmlentities($_REQUEST["custom_U1613"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Home Address:</b></td><td>' . htmlentities($_REQUEST["custom_U1640"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>City:</b></td><td>' . htmlentities($_REQUEST["custom_U1650"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Province:</b></td><td>' . htmlentities($_REQUEST["custom_U1656"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U1645"],ENT_COMPAT,'UTF-8') . '</td></tr>';
