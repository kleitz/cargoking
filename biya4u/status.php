...
$err=array('Please Fill The Status');
...
$query=mysqli_query($conn, "select * from status where category='$cat'");
...
if($num>0)
{
echo "<li>Status already Exists</li>";
...
$insert= mysqli_query($conn, "insert into status values('','$cat')");
 if($insert)
 {
 
 ?><script type="text/javascript">alert('Status Added Successfully'); self.location='status.php';</script><?php
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  align="center">
  ...
  <tr>
    <td ><p align="center" class="style1"> Add Status</p>
        <span class="">
        <?php if($_POST['submit'])
{
