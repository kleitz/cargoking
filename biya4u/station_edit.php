<?php 
	...
	$stationAdminInfo = getAssociativeArrayFromSQL($conn, "SELECT * FROM users WHERE user_type_id = " . STATION_ADMIN_ID . " AND id = '$md_edit' ");

	$errorNo  = "";
	$errorMsg = "";

	/* START: Submit Station Administrator Update */
	if($_POST['submit']) {
		...
		$SQLUpdate .= "   name = '$stationAdminName', ";
		$SQLUpdate .= "   station_id = $city, ";
		$SQLUpdate .= "   phone = '$stationAdminPhone', ";
		$SQLUpdate .= "   email = '$stationAdminEmailAddress', ";
		$SQLUpdate .= "   code = '$stationAdminCode', ";
		$SQLUpdate .= "   username = '$stationAdminUsername', ";
		$SQLUpdate .= "   password = '$stationAdminPassword', ";
		$SQLUpdate .= "   identification_type = '$stationAdminIdentificationType', ";
		$SQLUpdate .= "   identification_no = '$stationAdminIdentificationNo', ";
		...
		if( $successUpdate ) {
			...
			echo "	 window.opener.location.href='station_rep.php?action=update&success=true';";
			echo "   window.close();";
			echo "</script>";
		}
		else {
	...
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$("#btnUpdateStation").button();

				/*	
				$("#btnUpdateStation").bind("click", function(e){
					//console.log("bilat");
					var formObj = $("#frmStationAdmin");
					formObj.validate();
					//console.log("[Form validated]: " + formObj.valid());
					if(formObj.valid()) formObj.submit();
					e.preventDefault();
				});
				*/
				
				
				$("#selStationAdminIdentificationType").bind("change", function(){
					if($(this).val() == "-1")
						$("#txtStationAdminIdentificationNo").attr("readonly", "readonly");
					else
						$("#txtStationAdminIdentificationNo").removeAttr("readonly");
				});

				$("#sel_city").val("<?php echo $stationAdminInfo['station_id']; ?>");
				$("#selStationAdminIdentificationType").val("<?php echo $stationAdminInfo['identification_type']; ?>");
						...
						stationAdminName: {
							...
							remote: {
								...
								data: {
									...
									stationAdminId: '<?php echo $md_edit; ?>'
								}
							}*/
								...
								<td align="center">
									<form id="frmStationAdmin" name="frmStationAdmin" action="" method="post">
										<table width="600">
											...
											<tr>
												<td colspan="3"><p align="center" class="textShadow" style="font-size: 14px; font-weight: bold;">Update Station Administrator Details</p></td>
											</tr>
											<tr>
												<td colspan="3">
											...
											<tr>
												...
												<td width="435"><input type="text" id='txtStationAdminName' name="stationAdminName" value="<?php echo $stationAdminInfo['name']; ?>" class="form-field" style="width:255px;"/></td>
											</tr>
										   ...
										   <?php } ?>
											<tr>
												...
												<td width="435"><input type="text" id="txtStationAdminPhone" name="stationAdminPhone" value="<?php echo $stationAdminInfo['phone']; ?>" class="form-field" style="width:255px;" title="Optional, but needs to follow the format for mobile no. [(0912) 345-6789, (0912) 345 6789, (0912) 3456789, (0912)3456789], telephone no. [(082) 123-4567, (2) 1234567, (82) 123 4567, (6382)1234567]."/></td>
											</tr>
											<tr>
												<td width="17" class="required">*</td>
												<td width="153"><label for="txtStationAdminEmailAddress">Email</label></td>
												<td width="435"><input type="text" id="txtStationAdminEmailAddress" name="stationAdminEmailAddress" value="<?php echo $stationAdminInfo['email']; ?>" class="form-field" style="width:255px;" title="Required: Email Address following the format accountname@domain.com. Used for Activation and password reset." /></td>
											</tr>
											<tr>
												<td width="17">&nbsp;</td>
												<td width="153"><label for="txtStationAdminCode">Station Admin Code</label></td>
												<td width="435"><input type="text" id='txtStationAdminCode' name="stationAdminCode" class="form-field" value="<?php echo $stationAdminInfo['code']; ?>" class="form-field" style="width:255px;" /></td>
											</tr>
											<tr>
												<td width="17">&nbsp;</td>
											...
											<tr>
												...
												<td width="435"><input type="text" id='txtStationAdminIdentificationNo' name="stationAdminIdentificationNo" class="form-field" value="<?php echo $stationAdminInfo['identification_no']; ?>" style="width:255px;" title="Optional field, Identification number of the provided document for identity verification." readonly="readonly" /></td>
											</tr>
											<tr>
												<td width="17" class="required">*</td>
												<td width="153"><label for="txtStationAdminUsername">Username</label></td>
												<td width="153"><input type="text" id="txtStationAdminUsername" name="stationAdminUsername" class="form-field" value="<?php echo $stationAdminInfo['username']; ?>" autocomplete=off style="width:255px;" /></td>
											</tr>
											<tr>
												<td width="17" class="required">*</td>
												<td width="153"><label for="txtStationAdminPassword">Password</label></td>
												<td width="435"><input type="password" id="txtStationAdminPassword" name="stationAdminPassword" class="form-field" value="<?php echo $stationAdminInfo['password']; ?>" autocomplete=off style="width:255px;" /></td>
											</tr>
											<tr>
												<td width="17" class="required">*</td>
												<td width="153"><label for="txtStationAdminRetypedPassword">Confirm Passsword</label></td>
												<td width="435"><input type="password" id="txtStationAdminRetypedPassword" name="stationAdminRetypedPassword" class="form-field" value="<?php echo $stationAdminInfo['password']; ?>" autocomplete=off style="width:255px;" /></td>
											</tr>
											...
											<tr>
												...
												<td width="153">&nbsp;</td>
												<td width="435">
													<input type="submit" id="btnUpdateStation" name="submit" value="Update Station Administrator" style="margin-top: 20px; margin-right: 10px;" />
												</td>
											</tr>
