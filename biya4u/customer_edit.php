<?php 
	...
	//echo "[Customer ID]: " . $md_edit . "<br>";
	
	$customerInfo = getAssociativeArrayFromSQL($conn, "select * from customer where id = '$md_edit' ");
?>
	...
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$("#btnUpdateCustomer").button();
				$("#selCustomerIdentificationType").val("<?php echo $customerInfo['identification_type']; ?>");
				...
				<tr>
					<td>
						<table width="900" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
							<tr>
								<td><img src="images/logo.png" style="margin-top: 10px; margin-left: 10px;" /></td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>
									<p align="center" class="style1">Update Customer Details</p>
									<table width="883" align="center">
										...
										<tr>
											<td width="100%">
												<form id="formCustomer" name="formCustomer" action="updateCustomer.php" method="post">
													<input type="hidden" name="customer_id" value="<?php echo $md_edit; ?>" />
													<table>
														<tr>
															<td width="515" style="border-right: 1px solid #CCCCCC;">
																<table width="100%">
																	<tr>
																		<td width="15" class="required">*</td>
																		<td width="200"><label for="txtCustomerFirstName">First Name</label></td>
																		<td width="300"><input type="text" id='txtCustomerFirstName' name="customerFirstName" value="<?php echo $customerInfo['first_name']; ?>" class="form-field" style="width:255px;" /></td>
																	</tr>
																	<tr>
																		<td width="15" class="required">*</td>
																		<td width="200"><label for="txtCustomerLastName">Last Name</label></td>
																		<td width="300"><input type="text" id='txtCustomerLastName' name="customerLastName" value="<?php echo $customerInfo['last_name']; ?>" class="form-field" style="width:255px;" /></td>
																	</tr>
																	<tr>
																		<td width="15">&nbsp;</td>
																		<td width="200"><label for="txtCustomerMiddleName">Middle Name</label></td>
																		<td width="300"><input type="text" id='txtCustomerMiddleName' name="customerMiddleName" value="<?php echo $customerInfo['middle_name']; ?>" class="form-field" style="width:255px;" /></td>
																	</tr>
																	<tr>
																		<td width="15">&nbsp;</td>
																		<td width="200" height="98" valign="top"><label for="txtCustomerAddress">Address</label></td>
																		<td width="300"><textarea id='txtCustomerAddress' name="customerAddress" class="form-field" cols="30" rows="5" style="width:255px;"><?php echo $customerInfo['address']; ?></textarea></td>
																	</tr>
																<?php
																	if( $customerInfo['station_id'] ) {
																		$city = getAssociativeArrayFromSQL($conn,  "select * from bplace where id ='" . $customerInfo['station_id'] . "'" );
																?>
																	<tr>
																		<td width="15" class="required">*</td>
																		<td width="200"><label for="txtCustomerStation">Station</label></td>
																		<td width="300">
																...
																?>
																	<tr>
																		<td width="15" class="required">*</td>
																		<td width="200"><label for="sel_customerStation">Station</label></td>
																...
																?>
																	<tr>
																		<td width="15" class="required">*</td>
																		<td width="200"><label for="sel_city">Satellite Office</label></td>
																		<td width="300">
																			<?php
																				if( $customerInfo['station_id'] ) {
																					if( $customerInfo['satellite_office_id'] ){
																						$satelliteOffice = getAssociativeArrayFromSQL($conn,  "select * from deliveryarea where id ='" . $customerInfo['satellite_office_id'] . "'" );
																	...
																	<tr>
																		<td width="15">&nbsp;</td>
																		<td width="200"><label for="txtCustomerPhone">Phone</label></td>
																		<td width="300"><input type="text" id="txtCustomerPhone" name="customerPhone" value="<?php echo $customerInfo['phone']; ?>" class="form-field" style="width:255px;"/></td>
																	</tr>
																	<tr>
																		<td width="15">&nbsp;</td>
																		<td width="200"><label for="txtCustomerEmail">Email Address</label></td>
																		<td width="300"><input type="text" id="txtCustomerEmail" name="customerEmail" value="<?php echo $customerInfo['email_address']; ?>" class="form-field" style="width:255px;"/></td>
																	</tr>
																	<tr>
																		<td width="15">&nbsp;</td>
																		<td width="200"><label for="selCustomerIdentificationType">Identification Type</label></td>
																		<td width="300">
																	...
																	<tr>
																		<td width="15">&nbsp;</td>
																		<td width="200"><label for="txtCustomerIdentificationNo">Identification No.</label></td>
																		<td width="300"><input type="text" id='txtCustomerIdentificationNo' name="customerIdentificationNo" class="form-field" value="<?php echo $customerInfo['identification_number']; ?>" style="width:255px;" title="Optional field, Identification number of the provided document for identity verification." /></td>
																	</tr>
																</table>
															</td>
															<td valign="top">
																	...
																	<table width="300">
																		...
																		<tr id="trCustomerPercentage">
																			<td>
																				...
																				<input type="text" id="txtCustomerPercentageDiscount" name="customerPercentageDiscount" value="<?php echo $customerInfo['percentage_discount']; ?>" class="form-field" style="width: 75px; margin-left: 10px; display: inline;" />
																			</td>
																		</tr>
																	</table>
																</div>
														...
														<tr>
															<td colspan="2" align="center" style="border-top: 0px solid #cccccc;">
																<input type="submit" id="btnUpdateCustomer" name="submit" value="Update Customer" style="margin-top: 20px; margin-right: 10px;" />
															</td>
														</tr>
													</table>
												</form>
