...
$MYSQL_USER = 'tktrans_manman';
$MYSQL_PASSWD = 'BfaDm4{ff2s=';

// Backup destination (will be created if not aCKeady existing)
$BACKUP_DEST = '/home/tktrans/public_html/db_backups/';

// Temporary location (will be created if not aCKeady existing)
