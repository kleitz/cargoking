...
$upd_query = mysqli_query($conn, "update station set name='$nam',city='$city',phone='$phone',email='$tin',username='$uname' where id ='$md_edit' ")or die (mysqli_error());

print "<script>";
print "self.location='station_confirm.php'";
print "</script>";
...
<table width="580" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" >
  ...
  <tr>
    <td><p>&nbsp;</p>
      <div align="center" class="style2"><strong> Edit Station Details</strong></div>
     </td>
  </tr>
  ...
  <tr><td ><br />
  <?php 
  $row = getAssociativeArrayFromSQL($conn, "select * from station where id = '$md_edit' ");
   ?>
