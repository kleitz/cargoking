<?php 
	...
	$hawbBookingPrefix = $_SESSION['hawb_booking_prefix'];
	$weight = "";
								...
								<td>
									<form id="formNewHawb" name="formNewHawb" action="addHawbRecord.php" method="post">
											...
											<tr>
												...
												<td>           
													<div id="divCustomerList" style="width: 255px; position:absolute; top: 65px; left: 262px; display: none;">
														<ul id="min1" style="width:255px; background: #800000; border:1px solid #959595; padding:5px; line-height:25px; list-style:none; margin-top: 0px;" align="left"></ul>
													</div>
										...
										<table width="800" align="left" style="margin-left: 70px;">
											<tr>
												<td width="15" class="required">*</td>
												<td width="245"><label for="sel_rcity">Satellite Office(Branch)</label></td>
												<td width="560">
