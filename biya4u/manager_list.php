<?php 
  ...
  if(isset($_REQUEST['del_id'])) {
    ...
    echo "  self.location='manager_list.php?action=delete&success=true';";
    echo "</script>";
  }

  $stationFilter = ($stationId == "") ? "" : " AND station_id = " . $stationId;
  $total_results = (mysqli_query($conn, " select count(id) as row_count from vw_loginusers where user_type_id = " . MANAGER_ID . $stationFilter . " limit 1 ")); 
  ...
  $SQLManagers = "SELECT * FROM vw_loginusers WHERE user_type_id = " . MANAGER_ID . $stationFilter . " ORDER BY full_name desc LIMIT " . $offset . ", $limit ";
...
<head>
    ...
    <title>Cargo King: Station Manager</title>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $("#tblManagerList tr:odd").addClass("oddRow");
        $("#tblManagerList tr:even").addClass("evenRow");

        if( action == "add" && success == "true"){
          $("#divStatus").show();
          $("#divStatusMessage").html("Successfully added a station manager.").addClass("success");
        }
          ...
          $("#divStatus").show();
          $("#divStatusMessage").html("Successfully updated a station manager.").addClass("success");
        }
        else if( action == "delete" && success == "true"){
          $("#divStatus").show();
          $("#divStatusMessage").html("Successfully removed a station manager.").addClass("success");
        }
        else if( action == "delete" && success == "false"){
          $("#divStatus").show();
          $("#divStatusMessage").html("Cannot deleted active station manager.").addClass("error");
        }
        else {
        ...
        function deleteStationManager(deleteManagerId) {
          ...
          if( confirmDelete = confirm("Are you sure you want to remove  station manager?") ){
            location.href = "manager_list.php?del_id=" + deleteManagerId;
          }
  ...
  <center>
    ...
    <div class="containers contents">
      <div style="width: 800px; padding: 10px;">
        ...
        <!-- Title -->      
        <div align="center" class="title">Station Manager</div>
        ...
        <div class="clear" align="center">
          <div>
            <td>
                  <table id="tblManagerList" width="100%" border="0"  cellspacing="0" cellpadding="5" align="center" style="border:5px solid #bbbbbb; margin-bottom: 10px;">
                    <tr>
                      ...
                      <th class="tableHeader" style="width: 15%;"><div align="left"><strong>Station</strong></div></th>
                    ...
                    <tr>
                      ...
                      <td class="data" width="30%"><?php echo stripslashes($fet_2['full_name']); ?></td>
                      <td class="dataSmall" width="15%" style="padding-left: 10px;">
                        <?php  
                      ...
                      <td width="13%" style="padding-left: 15px;">
                        ...
                        <a class="actionButtons" href="javascript:void(0);" onclick="deleteStationManager(<?php echo  $fet_2['id']; ?>)"><img src="images/flat_icons/delete30.png" class="imageButtonFlat" alt="X" /></a>
                      </td>
                    </tr> 
                    <?php 
                        }
          ...
          <!-- START: Add Button -->
          <p align="right">
            <a id="lnkButton" href="javascript:void(0)" onclick="location.href='add_manager.php'" class="flatButton">Add Station Manager</a>
          </p>
          <!-- END: Add Button -->
          <br />
