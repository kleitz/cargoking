<?php
	...
	$downloadUrl = "xl_branch_monthly.php";
	...
	if( "" != $searchSatelliteOfficeId ) {
		...
		$SQLBranchTotals = " SELECT b.*, (b.insured_rate - b.discounted_total) as discounts FROM vw_booking_branch_totals_monthly b WHERE b.satellite_office_id = " . $searchSatelliteOfficeId;
	...
	$sqlTotalCount = " select count(id) as row_count from vw_booking_previous_month WHERE origin_id = " . $stationId . $SQLBranchFilter . " limit 1 ";
									...
									<table cellpadding="0" cellspacing="0" border="0" width="900" bgcolor="#FFFFFF">
										...
										<tr>
											<td colspan="2">
												<table width="98%" border="0" align="center" cellpadding="3" cellspacing="3">
													<tr>
														<td width="54%"><span class="Closed"><strong><?php echo ($totalCount ? $totalCount : 0); ?> </strong></span><strong>Results Found</strong>.</td>
