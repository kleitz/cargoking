...
$upd_query = mysqli_query($conn, "update user set name='$nam',city='$city',phone='$phone',email='$tin',username='$uname' where id ='$md_edit' ")or die (mysqli_error());

print "<script>";
print "self.location='user_confirm.php'";
print "</script>";
...
<table width="580" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" >
  ...
  <tr>
    <td><p>&nbsp;</p>
      <div align="center" class="style2"><strong> Edit User Details</strong></div>
     </td>
  </tr>
  ...
  <tr><td ><br />
  <?php 
  $row = getAssociativeArrayFromSQL($conn, "select * from user where id = '$md_edit' ");
   ?>
...
$replace = array('&quot;', '&#39;');
                ...
                <tr>
                  <td>Username</td>
                  <td><input type="text" name="uname" value="<?php echo stripslashes(str_replace($search, $replace,$row['username']));?>" style="width:255px;"/></td>
                </tr>
                <?php 
					$uname=$row['username'];
                ...
                <tr>
                  <td>Password</td>
                  <td><input type="text" name="pwd" value="<?php echo $pwd['adminpassword'];?>" style="width:255px;"/></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
