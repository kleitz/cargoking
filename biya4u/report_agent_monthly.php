<?php
	...
	if( "" != $searchAgentId ) {
		...
		$SQLAgentTotals = " SELECT b.*, (b.insured_rate - b.discounted_total) as discounts FROM vw_booking_agent_totals_monthly b WHERE origin_id = " . $stationId . " and agent_id = " . $searchAgentId;
	...
	$sqlTotalCount = " select count(id) as row_count from vw_booking_previous_month WHERE origin_id = " . $stationId;
