<?php
	...
	if ($data == "") {
		...
		$SQLBranchTotals = " SELECT b.*, (b.insured_rate - b.discounted_total) as discounts FROM vw_booking_branch_totals_weekly b WHERE b.satellite_office_id = " . $satelliteOfficeId;
	...
	$title = "Branch Weekly Sales Report";
	if("" != $branchName)
