<?php 
  ...
  if($_POST['submit']) {
    $typeOfShipment                  = mysqli_real_escape_string($conn, $_REQUEST['shipmentType']);
    $typeOfShipmentCode              = mysqli_real_escape_string($conn, $_REQUEST['shipmentCode']);
    $typeOfShipmentRemarks           = mysqli_real_escape_string($conn, $_REQUEST['shipmentRemarks']);

    $SQLInsert  = " insert into shipment_type (type_of_shipment, code, remarks, created_by, creation_date, last_modified_by, last_modified_date) ";
    $SQLInsert .= " values ('" . $typeOfShipment . "', '" . $typeOfShipmentCode . "', '" . $typeOfShipmentRemarks . "', '" . $login_id . "', now(), '" . $login_id . "', now())";
...
<head>
    ...
    <title>Cargo King: Add Shipment Type</title>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $("#formTypeOfShipment").validate({
          ...
          messages: {
            shipmentType: {
              required: "Please enter type of shipment.",
  ...
  <center>
    ...
    <div class="containers contents">
      <div class="contentContainer">
        ...
        <!-- Title -->      
        <div align="center" class="title">Add Shipment Type</div>
            ...
            <form id="formTypeOfShipment" name="formTypeOfShipment" action="" method="post">           
                <div class="formContainer">
                  <p>
                    ...
                    <label for="txtShipmentType" class="fieldLabel">Shipment Type:</label>
                    <input type="text" id="txtShipmentType" name="shipmentType" value="" class="profileField" />
                  </p>
                  <p>
                    <span class="not-required">&nbsp;</span>
                    <label for="txtShipmentCode" class="fieldLabel">Shipment Code:</label>
                    <input type="text" id="txtShipmentCode" name="shipmentCode" value="" class="profileField" />
                  </p>
                  <p>
                    <span class="not-required">&nbsp;</span>
                    <label for="txtShipmentCode" class="fieldLabel remarksLabel">Remarks:</label>
                    <textarea id="txtShipmentRemarks" name="shipmentRemarks" cols="100" rows="3" class="profileAddress" resizable="false"></textarea>
                  </p>
                </div>

                <p align="right" style="margin-right: -10px;">
                  <input type="submit" id="btnAddShipmentType" name="submit" value="Add Shipment Type" class="button" />
                </p>
            </form>
          </div>
        </div>
