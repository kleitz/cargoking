<?php 
  ...
  if(isset($_REQUEST['del_id'])) {
    ...
    if($modpay_num>0) {
      ...
      echo "  alert(\"List Available, So Can't Delete\");";
      echo "  self.location='move_rep.php';";
      echo "</script>";  
    }
    else {
      $del = mysqli_query($conn, "DELETE FROM movement WHERE id='$del_id_net' ") or die (mysqli_error());
      echo "<script type=\"text/javascript\">";
  ...
  $total_results = (mysqli_query($conn, "SELECT COUNT(*) as Num FROM movement ")); 
  ...
  $result = mysqli_query($conn, "SELECT * FROM movement  ORDER BY id desc LIMIT " . $offset . ", $limit ");
?>
...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" >
  ...
  <tr>
    <td><p>&nbsp;</p>
      <div align="center" class="style2"><strong> Type of Movement</strong></div>
     </td>
  </tr>
  ...
  <tr  id="head_bg"  bgcolor="#F4F4F4">
	    ...
	    <td class="wht_txt" width="19%"><div align="left"><strong>Id</strong></div></td>
         		 ...
         		 <td class="wht_txt" width="19%"><div align="left"><strong>Type of Movement</strong></div></td>	
...
//	include('results.php');
  ...
  <tr>
	...
	<td   width="19%"><a href="#" onClick="MM_openBrWindow('move_edit.php?ed=<?php echo  $fet_2['id']; ?> ','','scrollbars=yes,left=300,top=150,width=600,height=500')"   >Edit </a> &nbsp;&nbsp; <a href="?del_id=<?php echo  $fet_2['id']; ?>"  onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
