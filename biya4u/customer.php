	...
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$("#btnAddCustomer, #btnClearCustomer").button();
							...
							<tr>
								<td>
									...
									<table width="883" align="center">
										...
										<tr>
											<td width="100%">
												<form id="formCustomer" name="formCustomer" action="addCustomer.php" method="post">
													<table>
														<tr>
															<td width="515" style="border-right: 1px solid #CCCCCC;">
																<table width="100%">
																	...
																	<tr>
																		...
																		<td width="300"><textarea id='txtCustomerAddress' name="customerAddress" class="form-field" cols="30" rows="5" style="width:255px;"><?php echo $customerAddress; ?></textarea></td>
																	</tr>
																<?php
																	if( $stationId ) {
																			...
																			<?php
																				if( $stationId ) {
																					if( $satelliteOfficeId ){
																						...
																						echo "<input type=\"text\" id=\"txtSatelliteOffice\" name=\"satelliteOfficeName\" value=\"" . $satelliteOffice['city'] . "\" class=\"form-field\" style=\"width:255px;\"/>";
																					}
																					else {
																	...
																	<table width="300">
																		...
																		<tr id="trCustomerPercentage">
																			<td>
																				...
																				<input type="text" id="txtCustomerPercentageDiscount" name="customerPercentageDiscount" value="<?php echo $customerPercentageDiscount; ?>" class="form-field" style="width: 75px; margin-left: 10px; display: inline;" />
																			</td>
																		</tr>
																	</table>
																</div>
														...
														<tr>
															<td colspan="2" align="center" style="border-top: 0px solid #cccccc;">
																...
																<button type="button" id="btnClearCustomer" style="margin-top: 10px;">Clear Fields</button>
															</td>
														</tr>
													</table>
												</form>
