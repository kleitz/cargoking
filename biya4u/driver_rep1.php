...
*/
  ...
  $driver_query=mysqli_query($conn, "select * from invoice where driver='$del_id_net'");
  
  $driver_num=mysqli_num_rows($driver_query);
  
  if($driver_num>0)
  {
  ?><script type="text/javascript">alert("List Available, So Can't Delete");

self.location='driver_rep1.php';
  ...
  {
	 $del=mysqli_query($conn, "DELETE FROM driver WHERE id='$del_id_net' ") or die (mysqli_error());
  
  
  
 
 ?><script type="text/javascript">alert("One Record deleted successfully"); self.location='driver_rep1.php';</script><?php
...
$total_results = (mysqli_query($conn, "SELECT COUNT(*) as Num FROM driver ")); 
...
$result = mysqli_query($conn, "SELECT * FROM driver  ORDER BY id desc LIMIT " . $offset . ", $limit ");
...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" >
  ...
  <tr>
    <td><p>&nbsp;</p>
      <div align="center" class="style2"><strong>Manage Driver</strong></div>
     </td>
  </tr>
  ...
  <tr  id="head_bg"  bgcolor="#F4F4F4">
	    ...
	    <td class="wht_txt" width="19%"><div align="left"><strong>Id</strong></div></td>
         		 ...
         		 <td class="wht_txt" width="19%"><div align="left"><strong>Driver Name</strong></div></td>	
...
//	include('results.php');
  ...
  <tr>
	...
	<td   width="19%"><a href="#" onclick="MM_openBrWindow('driver_edit1.php?ed=<?php echo  $fet_2['id']; ?> ','','scrollbars=yes,left=300,top=150,width=600,height=500')"   >Edit </a> &nbsp;&nbsp; <a href="?del_id=<?php echo  $fet_2['id']; ?>
