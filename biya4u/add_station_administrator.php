<?php 
  ...
  if($_POST['submit']) {
    ...
    $SQLInsert .= " values (" . STATION_ADMIN_ID . ", '" . $code . "', '" . $identificationType . "', '" . $identificationNumber . "', '" . $firstName . "', '" . $lastName . "', '" . $middleName . "', '" . $area_name . "', '" . $phoneNumber . "', '" . $emailAddress . "', '" . $username . "', '" . $password . "', '" . $login_id . "', now(), '" . $login_id . "', now())";
    $successInsertion = mysqli_query($conn,  $SQLInsert );

    if( $successInsertion ) {
      echo "<script type=\"text/javascript\">";
      echo "  self.location='station_administrator_list.php?action=add&success=true';";
      echo "</script>";
    }
    else {
...
<head>
    ...
    <title>Cargo King: Add Station Administrator</title>
    ...
    <style>
      ...
      #sel_area_name, #selStationAdminIdentificationType {
        height: 32px;
        width: 323px;
      }
    </style>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $("#selStationAdminIdentificationType, #txtIdentificationNumber").bind("change", showHideIdentifactionInfo());
      ...
      var showHideIdentifactionInfo = function(){
        var idType = $("#selStationAdminIdentificationType").val();
  ...
  <center>
    ...
    <div class="containers contents">
      <div class="contentContainer">
        ...
        <!-- Title -->      
        <div align="center" class="title">Add Station Administrator</div>
            ...
            <form id="frmStationAdmin" name="frmStationAdmin" action="" method="post">           
                ...
                <div class="userAccessContainer">
                  ...
                  <p id="parIdType" style="margin-top: 20px;">
                    <span class="not-required">&nbsp;</span>
                    <label for="selStationAdminIdentificationType" class="fieldLabel">Identification Type:</label>
                    <select id="selStationAdminIdentificationType" name="identificationType" class="profileField" title="Optional field, provided identification card for verifying identity">
                ...
                <p align="right" style="margin-right: 10px;">
                  <input type="submit" id="btnAddStationAdministrator" name="submit" value="Add Station Administrator" class="button" />
                </p>
            </form>
          </div>
        </div>
