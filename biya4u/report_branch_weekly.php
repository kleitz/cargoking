<?php
	...
	$downloadUrl = "xl_branch_weekly.php?";
	$SQLBooking = "SELECT *, amount_due + declared_value_insurance as ckdue_w_insurance, commission - discount as commission_net FROM vw_booking_previous_week WHERE origin_id = " . $stationId;
	...
	if( "" != $searchSatelliteOfficeId ) {
		...
		$SQLBranchTotals = " SELECT b.*, (b.insured_rate - b.discounted_total) as discounts FROM vw_booking_branch_totals_weekly b WHERE b.satellite_office_id = " . $searchSatelliteOfficeId;
	...
	$sqlTotalCount = " select count(id) as row_count from vw_booking_previous_week WHERE origin_id = " . $stationId . $SQLBranchFilter . " limit 1 ";
