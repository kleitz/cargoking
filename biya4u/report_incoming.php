<?php
	...
	$SQLBooking = "SELECT * FROM vw_booking_details WHERE destination_id = $stationId and hawb_status <> 3 ";
	$strOrderBy = " ORDER BY hawb_date desc ";

	$SQLBookingResult = "";

	/* Get Results count */
	$rsBooking = mysqli_query($conn, $SQLBooking);
	$totalCount = 0;
	if($rsBooking){
		$totalCount = mysqli_num_rows($rsBooking);	
	}

	/* Get Booking Results */
	$SQLBookingResult = $SQLBooking . $strOrderBy . $strOffsetLimit;
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function getStationNameById(stationdId){
				var station_name = "";
									...
									<table cellpadding="0" cellspacing="0" border="0" width="900" bgcolor="#FFFFFF">
										<tr>
											<td colspan="2" align="center" style="height: 50px;">
												<span class="textShadow" style="font-size: 14px; font-weight: bold;">Report for 
												<?php
										...
										<tr>
											<td colspan="2">
												<table id="tab_bg" cellspacing="0" cellpadding="5" align="center" style="width: 950px; margin-left: 10px; border:1px solid #181818; margin-bottom: 5px; box-shadow: 3px 3px 3px #888888;">
													<tr  id="head_bg"  bgcolor="#F4F4F4">
														<td class="displayAllTableHeader" width="13%"><div align="left"><strong>HAWB Code</strong></div></td>
														<td class="displayAllTableHeader" width="16%"><div align="left"><strong>Consignee</strong></div></td>
														<td class="displayAllTableHeader" width="25%"><div align="left"><strong>Address</strong></div></td>
														<td class="displayAllTableHeader" width="15%"><div align="left"><strong>Contact No.</strong></div></td>
														<td class="displayAllTableHeader" width="10%"><div align="left"><strong>Origin</strong></div></td>
														<td class="displayAllTableHeader" width="13%"><div align="left"><strong>Branch</strong></div></td>
														<td class="displayAllTableHeader" width="8%"><div align="left"><strong>Action</strong></div></td>
													</tr>
													<?php
														if($totalCount > 0) {
													...
													?>
													<tr>
														<td width="13%" class="small"><?php echo $fet_2['booking_code']; ?></td>
														<td width="16%" class="small"><?php echo $fet_2['receiver_name']; ?></td>
														<td width="25%" class="small"><?php echo $fet_2['receiver_address']; ?></td>
														<td width="15%" class="small"><?php echo $fet_2['receiver_phone']; ?></td>
														<td width="10%" class="small"><?php echo $fet_2['origin']; ?></td>
														<td width="13%" class="small"><?php echo $fet_2['so_branch']; ?></td>
														<td width="8%">
															<a href="javascript:void(0);" class="actionButtons" onClick="MM_openBrWindow('hawb_edit.php?ed=<?php echo  $fet_2['id']; ?> ','','scrollbars=yes,left=150,top=10,width=900,height=900')">View</a>
														</td>
													</tr>
													<?php 
															}
