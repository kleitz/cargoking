<?php
	...
	/* Get Results count */
	$SQLCount         = $SQLBooking . ( $stationId > 0 ? " AND " . $strStationFilter : "");
									...
									<table cellpadding="0" cellspacing="0" border="0" width="900" bgcolor="#FFFFFF">
										<tr>
											<td colspan="2" align="center" style="height: 50px;">
												...
												<?php
													$rsBplace = mysqli_query($conn, "select * from bplace where id = $stationId");
													if($rsBplace) {
														$query = mysqli_fetch_array($rsBplace);
														echo $query['category'];
													}
												?>
												(Outgoing)
										...
										<tr>
											<td colspan="2">
												...
												?>
												<form id="formReportFilters" name="formReportFilters" method="get">
