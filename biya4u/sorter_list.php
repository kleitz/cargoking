<?php 
  ...
  if( $stationId != "" ) {
    ...
    echo "  self.location='sorter_list.php?action=delete&success=true';";
    echo "</script>";
  }

  $stationFilter = ($stationId == "") ? "" : " AND station_id = " . $stationId;
  $total_results = (mysqli_query($conn, " select count(id) as row_count from vw_loginusers where user_type_id = " . SORTER_ID . $stationFilter . " limit 1 "));
  ...
  $SQLSorters = "SELECT * FROM vw_loginusers WHERE user_type_id = " . SORTER_ID . $stationFilter . " ORDER BY full_name desc LIMIT " . $offset . ", $limit ";
...
<head>
    ...
    <title>Cargo King: Station Sorter</title>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        if( action == "add" && success == "true"){
          $("#divStatus").show();
          $("#divStatusMessage").html("Successfully added a sorter.").addClass("success");
        }
          ...
          $("#divStatus").show();
          $("#divStatusMessage").html("Successfully updated a sorter.").addClass("success");
        }
        else if( action == "delete" && success == "true"){
          $("#divStatus").show();
          $("#divStatusMessage").html("Successfully removed a sorter.").addClass("success");
        }
        else if( action == "delete" && success == "false"){
          $("#divStatus").show();
          $("#divStatusMessage").html("Cannot deleted active sorter.").addClass("error");
        }
        else {
        ...
        function deleteSorter(sorterId) {
          ...
          if( confirmDelete = confirm("Are you sure you want to remove sorter?") ){
            location.href = "sorter_list.php?del_id=" + sorterId;
          }
  ...
  <center>
    ...
    <div class="containers contents">
      <div style="width: 800px; padding: 10px;">
        ...
        <!-- Title -->      
        <div align="center" class="title">Station Sorters</div>
        ...
        <div class="clear" align="center">
          ...
          <!-- START: Add Button -->
          <p align="right">
            <a id="lnkButton" href="javascript:void(0)" onclick="location.href='add_sorter.php'" class="flatButton">Add Sorter</a>
          </p>
          <!-- END: Add Button -->
          <br />
