...
<div id="divDialog" class="dialogStyle">
  ...
  <div class="searchInfo">
    <p>
      ...
      <span class="searchValue">Juan Dela Cruz</span>  
    </p>
    <p>
      <span class="searchLabel">Recipient Name:</span>
      <span class="searchValue">Rosana Bin Laden</span>  
    </p>
    <p>
      <span class="searchLabel">Delivery Address:</span>
      <span class="searchValue">#123 Dimakita Street, Nawawala Subdivision, Dimahanap City 12345</span>  
    </p>
    <p>
      <span class="searchLabel">Recipient Contact Number:</span>
      <span class="searchValue">(082) 305-2123</span>  
    </p>
    <p>
      <span class="searchLabel">Cargo Item Status:</span>
      <span class="searchValue">For Delivery</span>  
    </p>
    <p>
      <span class="searchLabel">Cargo Last Location:</span>
      <span class="searchValue">Dimahanap City Cargo</span>  
    </p>
  </div>
...
<div>
        ...
        <li>
          ...
          <ul>
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='station.php'"><span>New Station Admininstrator</span></a></li>
                <li><a href="javascript:void(0)" onclick="location.href='station_rep.php'"><span>Display Station Admininstrators</span></a></li>
              </ul>
            </li>
            <li class='has-sub'>
              <a><span>Station Managers</span></a>
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='manager.php'"><span>New Station Manager</span></a></li>
                <li><a href="javascript:void(0)" onclick="location.href='manager_rep.php'"><span>Display Station Managers</span></a></li>
              </ul>
            </li>
            <li class='has-sub'>
              <a><span>Sorters</a>
              <ul>
                ...
                <li><a href="javascript:void(0)" onclick="location.href='sorters_rep.php'"><span>Display Station Sorters</span></a></li>
              </ul>
            </li>
            <li class='has-sub'>
              <a><span>Excess Baggage</span></a>
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='excess_baggage.php'"><span>New Station Excess Baggage</span></a></li>
                <li><a href="javascript:void(0)" onclick="location.href='excess_baggage_rep.php'"><span>Display Station Excess Baggages</span></a></li>
              </ul>
            </li>
            <li class='has-sub'>
              <a><span>Satellite Office Agent</span></a>
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='so_agent.php'"><span>New Satellite Office Agent</span></a></li>
                <li><a href="javascript:void(0)" onclick="location.href='so_agent_rep.php'"><span>Display Satellite Office Agents</span></a></li>
              </ul>
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul>
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='bookpl.php'"><span>New Station</span></a></li>
            ...
            <li class='has-sub'>
              ...
              <ul>
                ...
                <li><a href="javascript:void(0)" onclick="location.href='deliveryarea_rep.php'"><span>Manage Satellite Offices</span></a></li>
              </ul>
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul>
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='cat1.php'"><span>New shipment type</span></a></li>
            ...
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='weight.php'"><span>New weight break</span></a></li>
            ...
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='status.php'"><span>New status type</span></a></li>
            ...
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='move.php'"><span>New movement type</span></a></li>
            ...
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='mode.php'"><span>New payment mode</span></a></li>
            ...
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='sermode.php'"><span>New service mode</span></a></li>
            ...
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='vec.php'"><span>New cargo vehicle</span></a></li>
                <li><a href="javascript:void(0)" onclick="location.href='vehicles_list.php'"><span>Manage cargo vehicles</span></a></li>
              </ul>
            </li>
            <li class='has-sub'>
              <a><span>Delivery Personnel</span></a>
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='delivery_personnel.php'"><span>New delivery personnel</span></a></li>
          ...
          <ul>
            <li class='has-sub'>
              ...
              <ul>
                ...
                <li><a href="javascript:void(0)" onclick="location.href='manager_rep.php'"><span>Manage managers</span></a></li>
              </ul>
            </li>
            <li class='has-sub'>
              ...
              <ul>
                <li><a href="javascript:void(0)" onclick="location.href='sorters.php'"><span>New station sorter</span></a></li>
                <li><a href="javascript:void(0)" onclick="location.href='sorters_rep.php'"><span>Manage stations sorters</span></a></li>
              </ul>
            </li>
            <li class='has-sub'>
              <a><span>Excess Baggage</span></a>
              <ul>
                ...
                <li><a href="javascript:void(0)" onclick="location.href='excess_baggage_rep.php'"><span>Manage station excess baggage staffs</span></a></li>
              </ul>
            </li>
            <li class='has-sub'>
              ...
              <ul>
                ...
                <li><a href="javascript:void(0)" onclick="location.href='so_agent_rep.php'"><span>Manage satellite offices agents</span></a></li>
              </ul>
            </li>
          </ul>
        </li>
  ...
  <div class="welcome">
    <div class="searchCargoContainer">
      <input type="text" id="txtSearchCargo" maxlength="18" class="trackCargo" placeholder="Search Cargo" title="Enter HAWB ID to search" onkeydown="searchCargoItemByEnterKey(this.value, event);" />
