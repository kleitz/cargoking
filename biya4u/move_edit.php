...
$enum=mysqli_query($conn, "select * from movement where category='$fname'");

$nas=mysqli_num_rows($enum);
if($nas<1)
{
$upd_query = mysqli_query($conn, "update movement set category ='$fname' where id ='$id' ")or die (mysqli_error());
...
print "<script>";
print "self.location='move_confirm.php'";
print "</script>";
}
else
{
	
?><script type="text/javascript">alert("Type of Movement ACKeady Existed");</script><?php	
}
...
<table width="580" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" >
  ...
  $row = getAssociativeArrayFromSQL($conn, "select * from movement where id = '$md_edit' "));
   ?>
    <?php
        ...
        <tr>
          <td ><form id="form1" name="form1" method="post" action="">
              <table width="98%" border="0">
                <tr>
                  <td width="28%">Type of Movement*</td>
                  <td width="72%">
