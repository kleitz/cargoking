<?php 
  ...
  if(isset($_REQUEST['del_id'])) {
    ...
    if($station_num>0) {
      ...
      echo "  self.location='vehicles_list.php?action=delete&success=false';";
      echo "</script>";  
    }
    else {
      $del = mysqli_query($conn, "DELETE FROM vec WHERE id='$del_id_net' ") or die (mysqli_error());
      echo "<script type=\"text/javascript\">";
      echo "  self.location='vehicles_list.php?action=delete&success=true';";
      echo "</script>";
    }
  }
  ...
  $result = mysqli_query($conn, "SELECT * FROM vec ORDER BY id ASC LIMIT " . $offset . ", $limit ");
...
<head>
    ...
    <title>Cargo King: Cargo Vehicles</title>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        if( action == "add" && success == "true"){
          $("#divStatus").show();
          $("#divStatusMessage").html("Successfully added cargo vehicle.").addClass("success");
        }
          ...
          $("#divStatus").show();
          $("#divStatusMessage").html("Successfully updated cargo vehicle.").addClass("success");
        }
        else if( action == "delete" && success == "true"){
          $("#divStatus").show();
          $("#divStatusMessage").html("Successfully removed cargo vehicle.").addClass("success");
        }
        else if( action == "delete" && success == "false"){
          $("#divStatus").show();
          $("#divStatusMessage").html("Cannot delete active cargo vehicle.").addClass("error");
        }
        else {
      ...
      function deleteCargoVehicle(vehicleId) {
        var confirmDelete = false;
        if( confirmDelete = confirm("Are you sure you want to remove cargo vehicle?") ){
          location.href = "vehicles_list.php?del_id=" + vehicleId;
        }
  ...
  <center>
    ...
    <div class="containers contents">
      <div style="width: 800px; padding: 10px;">
        ...
        <!-- Title -->      
        <div align="center" class="title">Cargo Vehicles</div>
        ...
        <div class="clear" align="center">
          <div>
            ...
            <table id="tblStationsList" width="100%" border="0"  cellspacing="0" cellpadding="5" align="center" style="border:5px solid #bbbbbb; margin-bottom: 10px;">
              <tr>
                ...
                <th class="tableHeader" width="30%"><div align="left"><strong>Model &amp; Year</strong></div></td>
                <th class="tableHeader" width="10%"><div align="left"><strong>Place No.</strong></div></td>
                <th class="tableHeader" width="40%"><div align="left"><strong>Vehicle Information</strong></div></td>
              ...
              <tr>
                ...
                <td width="30%" class="data"><?php  echo stripslashes($fet_2['model_year']); ?></td>
                <td width="10%" class="data"><?php  echo stripslashes($fet_2['plate_no']); ?></td>
                <td width="40%" class="data"><?php  echo stripslashes($fet_2['vehicle_infos']); ?></td>
                <td width="10%">
                  <a href="javascript:void(0);" class="actionButtons" onClick="MM_openBrWindow('vec_edit1.php?ed=<?php echo  $fet_2['id']; ?> ','','scrollbars=yes,left=300,top=150,width=600,height=500')"><img src="images/flat_icons/pencil43.png" class="imageButtonFlat" alt="X" /></a>
                  <a href="javascript:void(0);" class="actionButtons" onclick="deleteCargoVehicle(<?php echo  $fet_2['id']; ?>)"><img src="images/flat_icons/delete30.png" class="imageButtonFlat" alt="X" /></a>
                </td>
              </tr> 
              <?php
                  }
          ...
          <!-- START: Add Button -->
          <p align="right">
            <a id="lnkButton" href="javascript:void(0)" onclick="location.href='add_cargo_vehicle.php'" class="flatButton">Add Cargo Vehicle</a>
          </p>
          <!-- END: Add Button -->
          <br />
